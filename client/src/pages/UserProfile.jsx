...
const UserProfile = () => {
  ...
  const fetchUserProfile = async () => {
    try {
      ...
      // Don't set loading to false here so we can show the error state
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
            ...
            {isOwnProfile && (
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link
                  to="/profile"
                  className="bg-gradient-to-r from-green-600 to-green-700 text-white px-6 py-3 rounded-xl hover:from-green-700 hover:to-green-800 transform hover:scale-105 transition-all duration-200 shadow-lg font-semibold flex items-center"
                >
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
